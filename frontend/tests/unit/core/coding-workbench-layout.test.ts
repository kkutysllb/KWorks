...
describe("coding workbench layout", () => {
  ...
  test("coding workbench places panel controls in the sidebar headers", () => {
    ...
    expect(workbench).toContain("AgentInspectorToolbarButton");
    expect(workbench).toContain('data-testid="agent-inspector-toolbar"');
    expect(workbench).toContain('aria-label="Agent 检查器视图"');
    expect(workbench).toContain("size-[26px]");
    expect(workbench).not.toContain("AgentInspectorTabTrigger");
    expect(workbench).not.toContain("TabsList");
    expect(workbench).not.toContain("TabsTrigger");
    expect(workbench).not.toContain("absolute top-1.5 z-30");
    expect(workbench).not.toContain("absolute top-1.5 left-2 z-30");
    expect(workbench).not.toContain("right-[22rem]");
    ...
    expect(workbench).not.toContain('value="events"');
    expect(workbench).not.toContain('value="session"');
