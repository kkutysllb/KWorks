...
<Callout type="info" emoji="📦">
  沙箱是 Agent 进行文件和命令操作的隔离工作区。它让 KWorks
  能够采取真实行动，而不仅仅是对话。
</Callout>
...
安装：`cd backend && uv add 'kkworks-harness[aio-sandbox]'`
...
| `.kkworks/threads/{thread_id}/user-data/` | `/mnt/user-data/`                             | 读写     |
...
<Cards num={2}>
  ...
  <Cards.Card title="子 Agent" href="/zh/docs/harness/subagents" />
</Cards>
