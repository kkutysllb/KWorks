...
<Callout type="info" emoji="🔧">
  工具是 Lead Agent 可以采取的行动。KWorks 提供内置工具、社区集成、MCP
...
安装：`cd backend && uv add 'kkworks-harness[tavily]'`
...
安装：`cd backend && uv add 'kkworks-harness[exa]'`
...
<Cards num={2}>
  <Cards.Card title="MCP 集成" href="/zh/docs/harness/mcp" />
  <Cards.Card title="技能" href="/zh/docs/harness/skills" />
</Cards>
