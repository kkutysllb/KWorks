...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes KWorks capable of real action, not just
  conversation.
</Callout>
...
KWorks supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: kkworks-sandbox)
  container_prefix: kkworks-sandbox
...
| `.kkworks/threads/{thread_id}/user-data/` | `/mnt/user-data/`                            | Read-write |
...
<Cards num={2}>
  ...
  <Cards.Card title="Subagents" href="/en/docs/harness/subagents" />
</Cards>
