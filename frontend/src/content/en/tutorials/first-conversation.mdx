...
description: This tutorial walks you through your first complete agent conversation in KWorks — from launching the app to getting meaningful work done with the agent.
---
...
This tutorial walks you through your first complete agent conversation in KWorks — from launching the app to getting meaningful work done with the agent.

## Prerequisites

- KWorks app is running (see [Quick Start](/docs/application/quick-start))
...
Open [http://localhost:9191](http://localhost:9191) in your browser. You will see the conversation workspace.
...
The agent used the KWorks Harness to:
