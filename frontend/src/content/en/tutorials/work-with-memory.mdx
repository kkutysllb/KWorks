...
description: This tutorial shows you how to enable and use KWorks's memory system so the agent remembers important information about you across multiple sessions.
---
...
This tutorial shows you how to enable and use KWorks's memory system so the agent remembers important information about you across multiple sessions.
...
Memory is stored in `backend/.kkworks/memory.json`:

```bash
cat backend/.kkworks/memory.json
```
...
```
backend/.kkworks/agents/{agent_name}/memory.json
```
...
- [Deploy Your Own KWorks](/docs/tutorials/deploy-your-own-kkworks)
