...
export const enUS: Translations = {
  ...
  settings: {
    ...
    import: {
      ...
      description:
        "Migrate custom skills, configuration, credentials and memory from an existing web deployment of KWorks into the desktop app. Shared skills on the web side become private copies on the desktop.",
      openWizard: "Open Migration Wizard",
      autoPromptTitle: "Web deployment detected",
      autoPromptDescription:
        "An existing KWorks web deployment was detected on this machine. Import its skills, config and memory now?",
