...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 KWorks，由 QiongQi 引擎驱动的桌面智能体工作台。通过统一的线程、任务、工具和观测能力，\nKWorks 可以帮你执行长任务、分析项目、管理记忆与状态，\n并把 Token、ROI 与结果文件沉淀到同一个工作空间。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来扩展 KWorks 与 QiongQi 的能力。通过自定义技能，KWorks\n可以把工具、知识和交付流程沉淀为可复用能力，\n服务你的项目、任务和团队工作流。",
    createCronJob: "创建自动化",
    createCronJobDescription:
      "通过对话描述你想要的自动化任务，Agent 会帮你设置时间表、选择智能体和提示词。例如每天早9点生成工作总结、每周五下午发送报告等。",
  },
  ...
  crons: {
    title: "自动化管理",
    description: "管理自动化任务，通过 Cron 表达式定时触发 AI 对话，实现自动化汇报、定期检查等工作流。",
    addJob: "添加任务",
    editJob: "编辑任务",
    deleteJob: "删除任务",
    ...
    guide: "配置帮助",
    guideIntro: "自动化任务通过 Cron 表达式调度，在指定时间自动触发 AI 对话。适合每日总结、定期数据检查、定时报告生成等场景。",
  ...
  toolCalls: {
    ...
    writeFile: "写入文件",
    editFile: "编辑文件",
    searchText: (pattern: string) => `搜索文本 “${pattern}”`,
    findFiles: (pattern: string) => `查找文件 “${pattern}”`,
  ...
  settings: {
    title: "设置",
    description: "管理 KWorks 外壳与 QiongQi 引擎的账号、模型、工具、技能、自动化和观测能力。",
    sections: {
      account: "账号与鉴权",
      appearance: "外观",
      memory: "记忆与状态",
    ...
    import: {
      title: "从 Web 端导入数据",
      description:
        "将 Web 端 KWorks 项目中的自定义技能、配置、凭证和记忆迁移到桌面端的私有目录。Web 端的公共技能迁移后将变为桌面端的私有副本，可自由修改。",
      openWizard: "打开迁移向导",
      autoPromptTitle: "检测到 Web 端项目",
      autoPromptDescription:
        "检测到本机已部署 Web 端 KWorks 项目。是否将其技能、配置和记忆迁移到桌面端？",
      ...
      wizard: {
        ...
        sourcePlaceholder: "选择 Web 端 KWorks 项目根目录",
    ...
    memory: {
      title: "记忆",
      description:
        "KWorks 会在后台不断从你的对话中自动学习。这些记忆能帮助 KWorks 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    tokenUsage: {
      ...
      tokensColumn: "Tokens",
      runsColumn: "运行次数",
      actualTokens: "实际消耗 Tokens",
      cacheHitTokens: "缓存命中 Tokens",
      tokenEconomySavings: "Token Economy 节省",
      cacheHitRate: "命中率",
