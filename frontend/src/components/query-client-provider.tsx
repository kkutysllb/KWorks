...
// Workspace routes can remount during project/task navigation. Keep recently
// fetched data fresh for a short window so returning to an active task does not
// fan out backend reads on every click.
const WORKSPACE_STALE_TIME_MS = 30 * 1000;
const WORKSPACE_GC_TIME_MS = 30 * 60 * 1000;
