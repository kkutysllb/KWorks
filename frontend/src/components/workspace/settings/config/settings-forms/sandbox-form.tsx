...
const defaultConfig: SandboxConfig = {
  use: "kkworks.sandbox.local:LocalSandboxProvider",
...
export function SandboxForm() {
  ...
  const handleProviderChange = (key: string) => {
    setProviderKey(key);
    if (key === "local") {
      update("use", "kkworks.sandbox.local:LocalSandboxProvider");
    } else {
      update("use", "kkworks.sandbox.docker:DockerSandboxProvider");
    }
  };
