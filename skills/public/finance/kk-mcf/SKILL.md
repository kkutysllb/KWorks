...
capabilities:
  ...
  - id: wacc-calculation
    description: "WACC计算：权益成本(CAPM)、债务成本、资本结构加权"
  - id: sensitivity-analysis
    description: "敏感性分析：关键假设变化对估值的多维敏感性"
  - id: excel-model-export
    description: "专业Excel模型输出：完整DCF模型、敏感性分析表、摘要页"
  - id: financial-data-sourcing
    description: "财务数据获取：从SEC申报和分析师资料获取财务数据"
