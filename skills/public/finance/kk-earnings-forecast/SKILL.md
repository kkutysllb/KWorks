...
capabilities:
  ...
  - id: bottom-up-forecast
    description: "自下而上预测法：量价拆解、客户/产品拆解、门店/用户拆解"
  - id: sue-analysis
    description: "标准化未预期盈利(SUE)分析：计算SUE值并生成交易信号"
  - id: pead-analysis
    description: "盈余公告后漂移(PEAD)分析：捕捉业绩超预期后股价漂移机会"
  - id: analyst-revision-momentum
    description: "分析师预期修正动量分析：ERM预期修正比率、变化幅度、离散度"
