...
capabilities:
  ...
  - id: earnings-surprise
    description: "盈利意外(SUE)分析：实际EPS vs 一致预期的标准化偏差"
  - id: pead-analysis
    description: "财报后漂移(PEAD)分析：业绩公告后的60-90日股价持续漂移"
  - id: guidance-analysis
    description: "管理层指引分析：指引类型解读、变更信号评分与语义分析"
  - id: earnings-quality
    description: "盈利质量评估：FCF转化率、应计比率、非GAAP差额等红旗检测"
