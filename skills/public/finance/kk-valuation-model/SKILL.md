...
capabilities:
  ...
  - id: relative-valuation
    description: "相对估值法：PE-Band、PB-ROE矩阵、EV-EBITDA等乘数估值"
  - id: sensitivity-analysis
    description: "敏感性分析：关键假设变动对估值结果的敏感性矩阵"
  - id: valuation-trap-detection
    description: "估值陷阱识别：深度价值陷阱、成长陷阱、周期陷阱等检测"
  - id: multi-model-cross-validation
    description: "多模型交叉验证：绝对+相对估值综合比较，目标价格区间生成"
